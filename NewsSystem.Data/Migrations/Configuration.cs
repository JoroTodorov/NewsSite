namespace NewsSystem.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<NewsSystemContext>
    {
        ...
        protected override void Seed(NewsSystemContext ctx)
        {
            if (ctx.Categories.Any() && ctx.Articles.Any())
            {
                return;
            }
            ...
            ApplicationUser user = new ApplicationUser() { UserName = "NeMeihti" };
